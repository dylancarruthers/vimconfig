...
hi Cursor ctermfg=231 ctermbg=0 cterm=NONE guifg=#f4f4f4 guibg=#000000 gui=NONE
...
hi MatchParen ctermfg=68 ctermbg=NONE cterm=underline guifg=#5b91e1 guibg=NONE gui=underline
...
hi IncSearch ctermfg=231 ctermbg=88 cterm=NONE guifg=#f4f4f4 guibg=#840e0b gui=NONE
...
hi DiffAdd ctermfg=0 ctermbg=149 cterm=bold guifg=#000000 guibg=#9fe65a gui=bold
hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE guifg=#f05252 guibg=NONE gui=NONE
hi DiffChange ctermfg=0 ctermbg=152 cterm=NONE guifg=#000000 guibg=#b3cae2 gui=NONE
